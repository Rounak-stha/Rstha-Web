...
const iconType = {
  question: {
    Icon: AiOutlineQuestionCircle, text: "Question"
  },
  info: {
    Icon: AiOutlineInfoCircle, text: "Info"
  },
  danger: {
    Icon: MdOutlineDangerous, text: "Danger"
  },
  warning: {
    Icon: MdOutlineDangerous, text: "Warning"
  },
  
};

const getBackgroundAndBorderClass = (type) => {
  switch (type) {
    case 'info':
      return 'dark:bg-blue-14 dark:border-blue-13 bg-blue-0 border-blue-1'
    case 'warning':
      return 'dark:bg-yellow-14 dark:border-yellow-13 bg-yellow-0 border-yellow-1 selection:bg-yellow-05 selection:text-yellow-7'
    case 'question':
      return 'dark:bg-green-14 dark:border-green-13 bg-green-0 border-green-1 selection:bg-green-05 selection:text-green-7'
    case 'danger':
      return 'dark:bg-red-14 dark:border-red-13 bg-red-0 border-red-1 selection:bg-red-05 selection:text-red-7'
  }
}
...
export default function Callout({ type = 'info', children, bold }) {
  ...
  const backgroundAndBorderClass = getBackgroundAndBorderClass(type)
  ...
  return (
    <div
      className={`not-prose p-4 px-5 rounded-lg border-2 ${backgroundAndBorderClass}`}
      style={{}}
    >
