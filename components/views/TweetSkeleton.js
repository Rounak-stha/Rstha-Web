  ...
  return (
    <div className="tweet rounded border border-gray-300 dark:border-gray-800 px-6 py-4 my-4 w-full">
      <div className="flex items-center">
        ...
        <div
          className="author flex-1 flex flex-col ml-4"
        >
          <span
            className="flex items-center w-40 h-[0.7rem] mb-[0.5rem] rounded skeleton"
          >
          </span>
          <span className="w-32 h-[0.7rem] mb-[0.5rem] rounded skeleton" >
          </span>
        </div>
        <a
          className="ml-auto"
