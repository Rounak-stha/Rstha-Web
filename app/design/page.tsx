    ...
    return (
        <>
            ...
            <ImageFlexBox
                images={[
                    {
                        src: 'https://cdn.sanity.io/images/vsfc0kgw/production/4c3c31e6ff7b6aec8dc469c50efc40dce2e3dc2f-5157x3438.jpg?width=800',
                        caption:
            ...
            <div className="mt-8 mb-14">
                ...
                <div id="font-family" className="mb-8">
                    ...
                    <P1 className="mb-4">
                        I see her everywhere in every beautiful things I see; on the mountains, on the grass, on the
                        Japanese Creamic Vessel, when smooth breeze runs through my skin.
                    </P1>
